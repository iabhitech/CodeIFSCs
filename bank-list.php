 ...
 if($city && !$branch){
  ...
  $tbody = '<tbody>';
   ...
   while($row = mysqli_fetch_assoc($result))
    ...
    $desc = "List of All Banks located in ".$city.". Find IFSC Code, MICR Code, Other Banks details";
    $title = "List of Banks in ".$city." - IFSC Code, MICR Code, Address, Contact Details";
    $keywords = $city.", IFSC Code, MICR Code, Bank Details, IFSC Code Bank, Find IFSC Code";
 ...
 elseif($branch && !$city){
  ...
  $tbody = '<tbody>';
   ...
   while($row = mysqli_fetch_assoc($result))
    ...
    $tbody = $tbody.'</tbody>';
    $desc = "List of All Banks located in Area ".$branch.". Find IFSC Code, MICR Code, Other Banks details";
    $title = "List of Banks in ".$branch." - IFSC Code, MICR Code, Address, Contact Details";
    $keywords = $branch.", IFSC Code, MICR Code, Bank Details, IFSC Code Bank, Find IFSC Code";
...
<body>
  ...
  <div class="container p-3" style="max-width:960px">
