          ...
          <div class="card-body indigo text-white">
            <form>
              <div class="form-group">
                ...
                <select class="custom-select my-1 mr-sm-2 indigo lighten-1 text-white" id="selBank" name="bank" onchange="updateState(this.value)">
                  <?php echo $banklist ?>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="custom-select my-1 mr-sm-2 indigo lighten-1 text-white" id="selState" name="state" onchange="updateCity(this.value)">
              ...
              <div class="form-group">
                ...
                <select class="custom-select my-1 mr-sm-2 indigo lighten-1 text-white" id="selCity" name="city" onchange="updateBranch(this.value)">
                  <?php echo $citylist ?>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="custom-select my-1 mr-sm-2 indigo lighten-1 text-white" id="selBranch" name="branch" onchange="updateSubmit(this.value)">
        ...
        <div id="ifsc" class="card mb-3">
          ...
          <div class="card-body indigo text-white">
            <form>
              ...
              <div class="form-group">
                <input type="text" class="form-control " id="ifsc-input" name="ifsc" placeholder="Enter IFSC Code" oninput="searchValidation(this)" />
